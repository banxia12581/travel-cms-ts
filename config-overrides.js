const { override, fixBabelImports, addLessLoader, addWebpackPlugin, addWebpackAlias, addDecoratorsLegacy, overrideDevServer } = require('customize-cra');
...
const devServerConfig = () => config => {
  return {
    ...
    proxy: {
      '/api': {
        target: 'http://106.55.168.13:9100',
        changeOrigin: true,
        secure: false,
      },
    },
